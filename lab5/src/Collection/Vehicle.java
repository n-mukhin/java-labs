...
public class Vehicle implements Comparable<Vehicle> {
    ...
    public Vehicle( long id, String name, Coordinates coordinates, java.time.LocalDate creationDate,
    ...
    public int compareTo (Vehicle o){
        ...
        if (result == 0) {
            if (this.distanceTravelled != null && o.distanceTravelled != null) {
                result = Float.compare(this.distanceTravelled, o.distanceTravelled);
            } else {
